 ...
 *
 */
public class JMSMessageListenerThreadImpl extends AbstractMessageListenerThread {

	private static Log log = LogFactory.getLog(JMSMessageListenerThreadImpl.class);

	public JMSMessageListenerThreadImpl(ClientUserInterface userInterface,
	...
	public void run() {
		...
		log.debug("JMSMessageListenerThread gestartet");
		...
		log.debug("Ordnungsgemaesses Ende des JMSMessageListener-Threads fuer User"
