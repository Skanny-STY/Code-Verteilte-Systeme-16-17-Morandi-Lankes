...
public class ChatPDU implements Serializable {
   ...
   * @return Erzeugte PDU
   */
  public static ChatPDU createLoginEventPdu(String userName,
	ChatPDU receivedPdu) {
   ...
   * @return Erzeugte PDU
   */
  public static ChatPDU createChatMessageEventPdu(String userName,
	ChatPDU receivedPdu) {
   ...
   * @return Erzeugte PDU
   */
  public static ChatPDU createLoginErrorResponsePdu(ChatPDU receivedPdu,
	int errorCode) {
